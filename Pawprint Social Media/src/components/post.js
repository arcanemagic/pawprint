...
import './post.css';
import username_logo from '../images/username_logo.png'
import comment_symbol from '../images/comment_symbol.png';
import nolikes from '../images/powell_cat_nolikes.png';
import likes from '../images/powell_cat_likes.png';
...
function Post(props){
    ...
    const addComment = () => {
        setComments([comments, <Comment key={inputText} userName = {props.accountName} text={inputText}/>]);
        setInputText('');
    }
    ...
    return(
        ...
        <div className="icons">
                {likeCount === 0? <Icon symbol={nolikes} altName="nolikes icon" />:
